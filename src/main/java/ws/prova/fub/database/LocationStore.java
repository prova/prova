 ...
 * 
 * <p>
 * Note: For now, this is a singleton. After we have a proper plugin architecture
 * (that is OSGi) in place, the 'database' plugin can create an instance of
 * this and pass it over to location and db_open builtins.
 * TODO un-singleton, let this be created within plugin main method.
 * 
 * <p>
 * Besides, this is not necessary at all. We could just let users define their locations
 * with Prova (with 'location' predicate) and fetch associated values from the KB.
 * TODO discuss this with Kia/Adrian/Alex
 *  
