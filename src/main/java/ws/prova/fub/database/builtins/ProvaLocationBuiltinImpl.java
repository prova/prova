 ...
 * 
 * @see LocationStore
 * @see ProvaDBOpenBuiltinImpl 
 * @author Malte Rohde <malte.rohde@inf.fu-berlin.de>
 */
public class ProvaLocationBuiltinImpl extends ProvaBuiltinImpl {

	private static Logger log = Logger.getLogger(ProvaLocationBuiltinImpl.class);
	
	public ProvaLocationBuiltinImpl(ProvaKnowledgeBase kb) {
		super(kb, "location");
	}
